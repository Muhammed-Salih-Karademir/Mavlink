...
#include </home/company-autonom/Desktop/mav/mavlink/generated/include/mavlink/v2.0/common/mavlink.h>
...
int main(int argc, char* argv[])
{
	...
	for (;;)
    {
		...
		mavlink_msg_heartbeat_pack(1, 133, &msg, MAV_TYPE_HELICOPTER, MAV_AUTOPILOT_GENERIC, MAV_MODE_GUIDED_ARMED, 0, MAV_STATE_ACTIVE);
    ...
    sprintf(str, "%d", tempdata);
		mavlink_msg_param_request_read_pack(1, 210, Lİon pil nedir &msg, 1,1,str,-1);
		len = mavlink_msg_to_send_buffer(buf, &msg);
		bytes_sent = sendto(sock, buf, len, 0, (struct sockaddr*)&gcAddr, sizeof(struct sockaddr_in));*/
		...
		/*mavlink_msg_jetson_pack(1, 210, &msg, microsSinceEpoch(), 25, 1.7, 60 , 0.01, 1, 4);
		len = mavlink_msg_to_send_buffer(buf, &msg);
		bytes_sent = sendto(sock, buf, len, 0, (struct sockaddr*)&gcAddr, sizeof(struct sockaddr_in));*/
		/* Send Local Position */
